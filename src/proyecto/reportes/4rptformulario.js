    ...
    try {
        ...
        const procesar = async () => {
            ...
            if (mes1.valido === 'true' && mes2.valido === 'true' && gestion.valido === 'true' && idVariable.valido === 'true' && alc.valido === 'true') {
                ...
                let data_ = []
                axios.post(URL + '/reportes4/listarcabeceras', { variable: idVariable.campo }).then(json => {
                    if (json.data.ok)
                ...
                if (alc.campo == 2) {
                    ...
                    axios.post(URL + '/reportes4/listarhospitales',).then(json => {
                        if (json.data.ok) {
                            let data__ = []
                            ...
                            json.data.data.forEach(h => {
                                ...
                                if ((contador_color % 2) == 0)
                                    axios.post(URL + '/reportes4/listarindicadores', { variable: idVariable.campo }).then(json => {
                                        if (json.data.ok) {
                                ...
                                else axios.post(URL + '/reportes4/listarindicadores', { variable: idVariable.campo }).then(json => {
                                    if (json.data.ok) {
                                        json.data.data.forEach(i => {
                                            i.color = 0
                                            i.est = null
                            ...
                            setTimeout(() => { setListaEstablecimientos([]); setListaEstablecimientos(data__); setEstado(0) }, 4000)
                        }
                        else { alert2({ icono: 'warning', titulo: 'Intente Nuevamente mas tarde!', boton: 'ok', texto: json.data.msg }); }
                    }).catch(function (error) { alert2({ icono: 'error', titulo: 'Error al conectar a la API', boton: 'ok', texto: error.toJSON().message }); });
                    ...
                    axios.post(URL + '/reportes4/listarhospitales',).then(json => {
                        json.data.data.forEach(h => {
                            axios.post(URL + '/reportes4/listardatosformulario', { est: h.id, variable: idVariable.campo, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                                if (json.data.ok)
                ...
                if (alc.campo == 1) {
                    ...
                    axios.post(URL + '/reportes4/listardatosformularioconsolidado', { variable: idVariable.campo, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                        if (json.data.ok) {
                            json.data.data[1].forEach(i => {
                                json.data.data[0].forEach(v => {
                                    if (parseInt(i.input) === parseInt(v.idinput)) {
                ...
                <div className="container_reportes_formulario">
                    ...
                    <div className='p-0 p-sm-2 p-md-3 p-lg-3 pb-0 pt-0 pt-lg-0 pt-md-0 pb-lg-0'>
                        <div className='orden-tiempo '>
                            <div className='col-12'>
                                <div className='row '>
                                    <div className='col-6 col-sm-4 col-md-2 col-lg-2 p-1' onClick={()=>setIdVariable({campo:null, valido:null})} >
                                        <SelectSM
                                            estado={ss}
                                            cambiarEstado={setSs}
                                    ...
                                    <div className='col-6 col-sm-2 col-md-2 col-lg-1 p-1' >
                                        <SelectSM
                                            estado={gestion}
                                    ...
                                    <div className='col-8 col-sm-8 col-md-4 col-lg-5 mb-2 p-1'  >
                                        <SelectSM
                                            estado={idVariable}
                                    ...
                                    <div className='col-4 col-sm-4 col-md-2 col-lg-2 mb-2 p-1' onClick={() => { setData([]); setListaEstablecimientos([]) }} >
                                        <SelectSM
                                            estado={alc}
                    ...
                    <div className='cajaprimario-reportes m-0 m-sm-2 m-md-3 m-lg-3 mt-0 mt-lg-0 '>
                        <div className='contenedor cajareportes p-3 p-sm-3 p-md-4 p-lg-4  pt-2 pb-2'>
                            {alc.campo == 1 && <p className='titulo-reportes' style={{ color: '#2980B9', textAlign: 'left', paddingLeft: '8px', marginBottom: '0', }}>
