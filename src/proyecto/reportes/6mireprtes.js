...
function Mireportes6() {
    ...
    try {
        ...
        const procesar = async () => {
            ...
            if (mes1.valido === 'true' && mes2.valido === 'true' && gestion.valido === 'true') {
                ...
                if (variablesSeleccionado.length > 0) {
                    axios.post(URL + '/reportes6/reportes-formularios-dividido-mi-formulario', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                        if (json.data.ok) {
                    ...
                    axios.post(URL + '/reportes6/reportes-formularios-enteros-mi-formulario', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                        if (json.data.ok) {
                            console.log('datos del server', json.data)
                            setData(json.data.dataForm)
                            setCabecera(json.data.cabeceras)
        ...
        const excel = () => {
            ...
            principal.getCell('C5').value = 'NIVEL FORMULARIO: AREA'
            ...
            principal.getCell('A6').value = 'FORMULARIO :  ' + localStorage.getItem('area')
