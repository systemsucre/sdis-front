    ...
    try {
        ...
        const listarMes = async () => {
            if (gestion.valido === 'true') {
                axios.post(URL + '/reportes5/listarmes', { id: gestion.campo, fecha: fecha + ' ' + horafinal }).then(json => {
                    if (json.data.ok) {
        ...
        const excel = () => {
            ...
            grupoSeleccionados.forEach(g => {
                axios.post(URL + '/reportes5/maxorden', { id: g }).then(json => {
                    if (json.data.ok) {
                    ...
                    <div className="container_reportes m-auto" style={{ width: '97%' }}>
                        ...
                        <div className='p-2'>
                            ...
                            <div className='botonModal p-1'>
                                <button className='botonProcesar' onClick={() => window.location.href = '/reportes5'}>CERRAR</button>
