...
function ReportesFormularioSedes() {
    ...
    const [alcanceEst, setAlcalceEst] = useState([{ id: 4, nombre: 'CONSOLIDADO' }, { id: 3, nombre: 'RED' }, { id: 2, nombre: 'MUNICIPIO' }, { id: 1, nombre: 'ESTABLECIMIENTO' }]);
    const [alcanceMunicipio, setAlcalceMunicipio] = useState([{ id: 4, nombre: 'CONSOLIDIDADO' }, { id: 3, nombre: 'RED' }, { id: 2, nombre: 'MUNICIPIO' }]);
    const [alcanceRed, setAlcalceRed] = useState([{ id: 4, nombre: 'CONSOLIDADO' }, { id: 3, nombre: 'RED' }]);

    const [alcance, setAlcalce] = useState([{ id: 4, nombre: 'CONSOLIDADO' }, { id: 3, nombre: 'RED' }, { id: 2, nombre: 'MUNICIPIO' }, { id: 1, nombre: 'ESTABLECIMIENTO' }]);
                                    ...
                                    <Table className=' table-sm' style={{ border: "1px solid #000040", borderRight: 'none', borderTop: '1px solid white', borderSpacing: '0px', padding: '0px' }} >
                                        {cabecera.length > 0 &&
                                            <thead className='cab-form'>
                                                <tr  >
                                                    <th className="col-3 mincelda var" style={{ color: '#595959', background: 'AliceBlue', borderRight: '1px solid #000040', borderTop: '1px solid #000040', }}>ENTIDAD</th>
