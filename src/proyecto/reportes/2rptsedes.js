...
function ReportesSedes() {
    ...
    const [listaNivelAplicacion, setListaNivelAplicacion] = useState([{ id: 1, nombre: 'ESTABLECIMIENTOS' }, { id: 2, nombre: 'MUNICIPIO' }, { id: 3, nombre: 'RED' }, { id: 4, nombre: 'AREA' }]);
    ...
    const [estab, setEstab] = useState({ campo: 1000, valido: 'true' })
    ...
    try {
        ...
        useEffect(() => {
            ...
            if (nivelAplicacion.campo == 1) {
                listarEntidadFormularioEstablecimiento()
                if (ss.campo == 1000)
                    listarTodosGrupos()
                else listarGrupos()
            }
            ...
            if (nivelAplicacion.campo == 2) {
                listarEntidadFormularioMunicipio()
                if (ss.campo == 1000) listarTodosGruposMun()
                else listarGruposMun()
            }
            if (nivelAplicacion.campo == 3) {
                listarEntidadFormularioRed()
                if (ss.campo == 1000) listarTodosGruposRed()
                else listarGruposRed()
            }
            if (nivelAplicacion.campo == 4) {
                if (ss.campo == 1000) listarTodosGruposArea()
                else listarGruposArea()
            }
        ...
        const listarEntidadFormularioEstablecimiento = async () => {
            console.log('listar hospitales ')
            axios.post(URL + '/reportes2/entidad-formulario-est').then(json => {
                if (json.data.ok)
                    setEst(json.data.data)
                else toast.error(json.data.msg)
            }).catch(function (error) { alert2({ icono: 'error', titulo: 'Error al conectar a la API', boton: 'ok', texto: error.toJSON().message }); });
        }

        const listarEntidadFormularioMunicipio = async () => {
            console.log('listar municipios')
            axios.post(URL + '/reportes2/entidad-formulario-municipio').then(json => {
                if (json.data.ok)
                    setEst(json.data.data)
                else toast.error(json.data.msg)
            }).catch(function (error) { alert2({ icono: 'error', titulo: 'Error al conectar a la API', boton: 'ok', texto: error.toJSON().message }); });
        ...
        const listarEntidadFormularioRed = async () => {
            console.log('listar municipios')
            axios.post(URL + '/reportes2/entidad-formulario-red').then(json => {
                if (json.data.ok)
                    setEst(json.data.data)
                else toast.error(json.data.msg)
            }).catch(function (error) { alert2({ icono: 'error', titulo: 'Error al conectar a la API', boton: 'ok', texto: error.toJSON().message }); });
        ...
        const listarTodosGrupos = async (id = null) => {
            ...
            if (gestion.valido === 'true' || id) {
                axios.post(URL + '/reportes2/listartodosvariable', { id: id ? id : gestion.campo, }).then(json => {
                    if (json.data.ok) {
        ...
        const listarGrupos = async () => {
            ...
            if (gestion.valido === 'true') {
                axios.post(URL + '/reportes2/listarvariable', { id: gestion.campo, ssector: ss.campo }).then(json => {
                    if (json.data.ok) {
                        setListaGrupo(json.data.data)
                        // console.log(json.data.data,'data de la bd')
                    } else alert2({ icono: 'warning', titulo: 'Intente Nuevamente mas tarde!', boton: 'ok', texto: json.data.msg })
        ...
        const listarTodosGruposMun = async (id = null) => {
            // console.log('todos los grupos')
            if (gestion.valido === 'true' || id) {
                axios.post(URL + '/reportes2/listartodosvariable-mun', { id: id ? id : gestion.campo, }).then(json => {
                    if (json.data.ok) {
                        setListaGrupo(json.data.data)
        ...
        const listarGruposMun = async () => {
            // console.log('grupos elegidos')
            if (gestion.valido === 'true') {
                axios.post(URL + '/reportes2/listarvariable-mun', { id: gestion.campo, ssector: ss.campo }).then(json => {
                    if (json.data.ok) {
                        setListaGrupo(json.data.data)
                        setEstab({ campo: 1000, valido: 'true' })
                        // console.log(json.data.data,'data de la bd')
        ...
        const listarTodosGruposRed = async (id = null) => {
            // console.log('todos los grupos')
            if (gestion.valido === 'true' || id) {
                axios.post(URL + '/reportes2/listartodosvariable-red', { id: id ? id : gestion.campo, }).then(json => {
                    if (json.data.ok) {
                        setListaGrupo(json.data.data)
                        setEstab({ campo: 1000, valido: 'true' })
                        // console.log(json.data.data,'data de la bd')
        ...
        const listarGruposRed = async () => {
            // console.log('grupos elegidos')
            if (gestion.valido === 'true') {
                axios.post(URL + '/reportes2/listarvariable-red', { id: gestion.campo, ssector: ss.campo }).then(json => {
                    if (json.data.ok) {
                        setListaGrupo(json.data.data)
                        setEstab({ campo: 1000, valido: 'true' })
                        // console.log(json.data.data,'data de la bd')
        ...
        const listarTodosGruposArea = async (id = null) => {
            // console.log('todos los grupos')
            if (gestion.valido === 'true' || id) {
                axios.post(URL + '/reportes2/listartodosvariable-area', { id: id ? id : gestion.campo, }).then(json => {
                    if (json.data.ok) {
                        setListaGrupo(json.data.data)
                        setEstab({ campo: 1000, valido: 'true' })
                        // console.log(json.data.data,'data de la bd')
        ...
        const listarGruposArea = async () => {
            // console.log('grupos elegidos')
            if (gestion.valido === 'true') {
                axios.post(URL + '/reportes2/listarvariable-area', { id: gestion.campo, ssector: ss.campo }).then(json => {
                    if (json.data.ok) {
                        setListaGrupo(json.data.data)
                        setEstab({ campo: 1000, valido: 'true' })
                        // console.log(json.data.data,'data de la bd')
        ...
        const procesar = async () => {
            console.log(nivel, nivelAplicacion, ' datos parametros vvv')
            if (ss.valido === 'true' && mes1.valido === 'true' && mes2.valido === 'true' && gestion.valido === 'true' && estab.valido === 'true') {
                if (grupoSeleccionados.length > 0) {
                    if (nivelAplicacion.campo == 1) {
                        ...
                        if (nivel == 5) {
                            ...
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-est-nivel-5', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-est-nivel-5', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                        ...
                        if (nivel == 4) {
                            ...
                            setTexto('Procesando la informacion...')
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-est-nivel-4', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-est-nivel-4', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                        ...
                        if (nivel === 3) {
                            ...
                            setTexto('Procesando la informacion...')
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-est-nivel-3', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-est-nivel-3', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                        ...
                        if (nivel === 1000) {
                            ...
                            setTexto('Procesando la informacion...')
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-est-consolidado', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-est-consolidado', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                    ...
                    if (nivelAplicacion.campo == 2) {
                        ...
                        if (nivel == 4) {
                            ...
                            setTexto('Procesando la informacion...')
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-mun-nivel-4', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                                        setListaIndicadores(json.data.indicadores)
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-mun-nivel-4', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                        ...
                        if (nivel === 3) {
                            ...
                            setTexto('Procesando la informacion...')
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-mun-nivel-3', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-mun-nivel-3', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                        ...
                        if (nivel === 1000) {
                            ...
                            setTexto('Procesando la informacion...')
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-mun-consolidado', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-mun-consolidado', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                    ...
                    if (nivelAplicacion.campo == 3) {
                        ...
                        if (nivel === 3) {
                            ...
                            setTexto('Procesando la informacion...')
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-red-nivel-3', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-red-nivel-3', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, est: estab.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                        ...
                        if (nivel === 1000) {
                            ...
                            setTexto('Procesando la informacion...')
                            if (variablesSeleccionado.length > 0) {
                                axios.post(URL + '/reportes2/reportes-formularios-dividido-red-consolidado', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                                ...
                                axios.post(URL + '/reportes2/reportes-formularios-enteros-red-consolidado', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo }).then(json => {
                                    if (json.data.ok) {
                                        console.log('datos del server', json.data)
                                        setData(json.data.dataForm)
                                        setCabecera(json.data.cabeceras)
                    ...
                    if (nivelAplicacion.campo == 4) {
                        ...
                        setTexto('Procesando la informacion...')
                        if (variablesSeleccionado.length > 0) {
                            axios.post(URL + '/reportes2/reportes-formularios-dividido-area', { lista: variablesSeleccionado, variable: grupoSeleccionados[0], gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, }).then(json => {
                                if (json.data.ok) {
                                    console.log('datos del server', json.data)
                                    setData(json.data.dataForm)
                                    setCabecera(json.data.cabeceras)
                            ...
                            axios.post(URL + '/reportes2/reportes-formularios-enteros-area', { lista: grupoSeleccionados, gestion: gestion.campo, mes1: mes1.campo, mes2: mes2.campo, }).then(json => {
                                if (json.data.ok) {
                                    console.log('datos del server', json.data)
                                    setData(json.data.dataForm)
                                    setCabecera(json.data.cabeceras)
                ...
                } else toast.error('selecione una o mas opciones del formulario')
        ...
        const excel = () => {
            ...
            if (nivelAplicacion.campo == 1) {
                ...
                if (nivel == 4) { // mun
                    principal.getCell('C4').value = 'MUNICIPIO: ' + entidad
                }
                if (nivel == 3) { // red
                    principal.getCell('C4').value = entidad
                }
                if (nivel == 1000) { // consolidado
                    principal.getCell('C4').value = 'DEPTO CHUQUISACA'
            ...
            if (nivelAplicacion.campo == 4) {
                principal.getCell('C4').value = 'REPORTE DE AREA'
            }
                ...
                {ventana === 0 ?
                    <div className="container_reportes_formulario ">
                        <div className='header-reportes'>
                            ...
                            <p style={{ fontSize: '15px', fontWeight: 'bold', color: '#595959', textAlign: 'center', marginBottom: '0' }} className='text-center'>
                                SEDES CH</p>
                        ...
                        <div className='p-0 p-sm-2 p-md-3 p-lg-3 pb-0 pt-0 pt-lg-0 pt-md-0 pb-lg-0'>
                            <div className='orden-tiempo '>
                                ...
                                <div className='col-12 '>
                                    <div className='row'>
                                        <div className='col-6 col-sm-8 col-md-2 col-lg-2 p-1' onClick={() => {
                                        ...
                                        {nivelAplicacion.campo < 4 && <div className='col-12 col-sm-12 col-md-3 col-lg-3 p-1' onClick={() => {
                                            ...
                                            <SelectSMString
                                                ...
                                                lista={est}
                                                etiqueta={nivelAplicacion.campo == 1 ? 'Tipo Reporte' : nivelAplicacion.campo == 2 ? 'Municipio' : 'Red'}
                                                msg='Seleccione una opcion'
                                                nivel={setNivel}
                                            />
                                        </div>}
                    ...
                    <div className="container_reportes m-auto" style={{ width: '97%' }} >
                        ...
                        {nivelAplicacion.campo == 1 && <>
                            ...
                            {
                                nivel == 1000 && <p className='titulo-reportes_1' style={{ marginBottom: '0px', color: '#023c52', }}>DPTO. CHUQUISACA</p>
                            }
                        </>}
                        {
                        ...
                        {
                            nivelAplicacion.campo == 4 && <p className='titulo-reportes_1' style={{ marginBottom: '0px', color: '#023c52', }}>REPORTE AREA </p>
                        ...
                        <div className='p-2'>
                            ...
                            <div className='botonModal p-1'>
                                <button className='botonVolversm' onClick={() => window.location.href = '/reportes-por-sedes'}>Volver</button>
