    ...
    try {
        ...
        const listarMes = async (id = null) => {
            if (gestion.valido === 'true' || id) {
                axios.post(URL + '/opeinf3/listarmes', { id: id ? id : gestion.campo, fecha: fecha + ' ' + horafinal }).then(json => {
                    if (json.data.ok) {
        ...
        const procesar = async () => {
            ...
            if (mes1.valido === 'true' && gestion.valido === 'true')
                ...
                axios.post(URL + '/opeinf3/listardatos', { gestion: gestion.campo, mes1: mes1.campo }).then(json => {
                    if (json.data.ok) {
        ...
        const excel = () => {
            ...
            const principal = workbook.addWorksheet('OPORTUNIDAD DE INFORMACION '+localStorage.getItem('red'), {
                properties:
                {
            ...
            principal.getCell('C6').value =  localStorage.getItem('red')
