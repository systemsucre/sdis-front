    ...
    try {
        ...
        const listarMes = async (id = null) => {
            if (gestion.valido === 'true' || id) {
                axios.post(URL + '/registro/listarmes', { id: id ? id : gestion.campo, fecha: fecha + ' ' + horafinal }).then(json => {
                    if (json.data.ok) {
        ...
        return (
            <div className="container_formulario">
                <div className='contenedor-cabecera row' >
                    ...
                    <p style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '0', color: '#595959' }} className='text-center'>{'ESTABLECIMIENTO: ' + localStorage.getItem('est')}  </p>
                </div>
                ...
                <div className='orden-tiempo '>
                    <div className='row'>
                        <div className='col-6 col-sm-6 col-md-3 col-lg-3 p-1' onClick={() => {
                            setMes({ campo: null, valido: null }); setListaMes([]); setListaIndicadores([]); setVariable({ campo: null, valido: null }); setListaVariable([]); setListaInput([]); setListaCabecera([])
                        }}>
                            <Select1XL
                                estado={gestion}
                        ...
                        <div className='col-12 col-sm-12 col-md-6 col-lg-5 p-1' onClick={() => {
                                    ...
                                    <thead className='cab-form'>
                                        ...
                                        <tr style={{ borderTop: '1px solid #595959' }}>
                                            {maxOrden === 2 ? <th className="col-4 mincelda " style={{ color: '#595959', background: 'AliceBlue', borderRight: '1px solid #000040', borderTop: '0', }}>{'VARIABLE'}</th> :
                                                maxOrden === 1 ? null : <th className="col-4 mincelda var" style={{ color: '#595959', background: 'AliceBlue', borderRight: '1px solid #000040', borderTop: '0', }}></th>}
                                            {listaCabecera.map(cb => (
                                                parseInt(cb.nivel) == 2 &&
                                                <th className=' nivel1F' style={{
                                                    background: 'AliceBlue',
